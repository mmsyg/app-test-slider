...
const Slider = () => {
    ...
    return ( <div className="slider">
        <SetRight/>
    <Link to="/"><Home className ="home_b"/>
    <Tile className = "tile_left" /><img src={`${data.images[0].path}` } alt="tile_left_pht" className="tile_left_photo" /> <p className="tile1_title">{data.images[0].name}</p></Link>
