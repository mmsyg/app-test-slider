    ...
    return (
      <div className="quiz_answer">
        <div className="jp" onClick={() => ifCorrect(0)}>
          <QuizzTile className="jp" answer={arrayIsCorrect[0]} id={props.id} abc="A" tileLetter="A" />
        </div>
        <div className="op" onClick={() => ifCorrect(1)}>
          <QuizzTile className="ee" answer={arrayIsCorrect[1]} id={props.id} abc="B" tileLetter="B" />
        </div>
        <div className="wo" onClick={() => ifCorrect(2)}>
          <QuizzTile className="aa" answer={arrayIsCorrect[2]} id={props.id} abc="C" tileLetter="C" />
        </div>
        {console.log(score)}
      </div>
    );
